 ...
 * Komponen Footer
 * 
 * Footer aplikasi yang berisi:
 * - Brand logo dan deskripsi
 * - Social media links (YouTube, Instagram, Facebook)
 * - Navigasi link (Telusuri & Bantuan)
 * - Form berlangganan newsletter
 * - Copyright information
 * 
 * Background color: #2C3C4D (news-navy)
 */
...
import { FaFacebookF, FaInstagram, FaTwitter, FaFacebook, FaTelegramPlane, FaYoutube } from 'react-icons/fa';
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            />
                            <span className="text-2xl font-bold font-poppins">Berita Kini</span>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex gap-3">
                                <a href="#" className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-news-blue transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/berita/hiburan" className="text-gray-300 hover:text-white transition-colors">Hiburan</Link></li>
                            <li><Link href="/berita/gaya-hidup" className="text-gray-300 hover:text-white transition-colors">Gaya Hidup</Link></li>
                            <li><Link href="/berita/olahraga" className="text-gray-300 hover:text-white transition-colors">Olahraga</Link></li>
                            <li><Link href="/berita/nasional" className="text-gray-300 hover:text-white transition-colors">Nasional</Link></li>
                            <li><Link href="/berita/internasional" className="text-gray-300 hover:text-white transition-colors">Internasional</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">FAQ's</Link></li>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full rounded-md bg-white border border-white/20 px-4 py-2 pr-10 text-sm text-white placeholder:text-gray-400 focus:border-news-blue focus:outline-none"
                            />
